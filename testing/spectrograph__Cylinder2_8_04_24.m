...
start_time = new_time_utc(4500);  % Start time (first timestamp in the interpolated signal)
end_time = new_time_utc(7000);  % End time (last timestamp in the interpolated signal)
